...
{
    internal class ConvertContract
    {
        private FileInfo _fileInfo;

        public ConvertContract(string fileName)
        {
        ...
        internal bool StartConvert(string id)
        {
            ...
            try
            {
                ...
                var wordDocument = appWord.Documents.Open(@$"C:\Users\SiBro\source\repos\AkmullaBSPU_bot\AkmullaBSPU_bot\bin\Debug\netcoreapp3.1\{id}Contract.docx");
                wordDocument.ExportAsFixedFormat(path + @"\Contract.pdf", Word.WdExportFormat.wdExportFormatPDF);
